        ...
        <div className="bg-white border border-[#B08B46]/30 rounded-sm p-8 sm:p-12 mb-16 shadow-md relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              ...
              <p className="text-sm text-[#5A5854] leading-relaxed font-normal">
              ...
              <div className="space-y-2 pt-2 text-xs font-semibold text-[#1C1D21]">
            ...
            <div className="bg-[#FAF7F2] border border-[#B08B46]/30 p-6 rounded-sm space-y-4">
              ...
              <div className="flex flex-wrap gap-2 pt-2">
                {promotedLocations.map((loc, idx) => (
                  <span
                    key={idx}
                    className="px-3 py-1 bg-white border border-[#7A1C20]/20 rounded-sm text-xs font-serif font-semibold text-[#7A1C20] shadow-sm"
                  >
                    {loc}
                  </span>
                ))}
              ...
              >
                <div>
                  ...
                  <div className="p-6 space-y-2">
                    <h4 className="text-xl font-serif font-bold text-[#1C1D21] group-hover:text-[#7A1C20] transition-colors">
                      {art.title}
                    </h4>
