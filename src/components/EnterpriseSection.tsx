...
export const EnterpriseSection: React.FC<EnterpriseSectionProps> = ({ onInquire }) => {
  ...
  return (
    <section id="enterprise-section" className="py-24 bg-[#FAF8F5] text-[#1C1D21] relative border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="p-6 bg-white border border-[#B08B46]/30 rounded-sm space-y-3 shadow-sm">
              ...
              <div className="flex items-center justify-between text-xs border-t border-gray-100 pt-3">
                ...
                <a
                  ...
                  className="text-[#8A6B29] font-mono hover:underline flex items-center space-x-1 font-semibold"
                >
          ...
          <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
            {pillars.map((pil, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="p-6 bg-white border border-[#B08B46]/25 rounded-sm hover:border-[#B08B46] hover:shadow-md transition-all group"
                >
                  <div className="w-10 h-10 rounded bg-[#B08B46]/10 border border-[#B08B46]/30 flex items-center justify-center mb-4 text-[#8A6B29] group-hover:scale-110 transition-transform">
