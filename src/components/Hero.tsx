...
export const Hero: React.FC<HeroProps> = ({ onExploreGroup, onChairmanMessage }) => {
  return (
    <section id="hero" className="relative min-h-screen bg-[#FFFFFF] text-[#1C1D21] flex items-center pt-28 pb-16 overflow-hidden border-b border-gray-100">
      ...
      <div className="absolute top-1/4 left-10 w-96 h-96 bg-[#B08B46]/10 rounded-full blur-3xl pointer-events-none"></div>
      <div className="absolute bottom-10 right-10 w-[500px] h-[500px] bg-[#FAF7F2] rounded-full blur-3xl pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full my-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-6 text-xs text-[#5A5854] font-medium">
              <div className="flex items-center space-x-2">
                <ShieldCheck className="w-4 h-4 text-[#B08B46]" />
                <span>Diversified Bhutanese Portfolio</span>
              </div>
              <div className="flex items-center space-x-2">
                <Award className="w-4 h-4 text-[#B08B46]" />
            ...
            <div className="pt-6 flex flex-wrap gap-4 items-center">
              <button
                ...
                className="px-7 py-3.5 text-xs uppercase tracking-[0.2em] font-bold text-white bg-[#1C1D21] hover:bg-[#B08B46] transition-all rounded-sm shadow-md flex items-center space-x-3 group"
              >
                <span>Explore the Group</span>
                <ArrowRight className="w-4 h-4 text-[#B08B46] group-hover:text-white group-hover:translate-x-1 transition-all" />
              </button>
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="absolute -inset-2 rounded-sm border border-[#B08B46]/30 -rotate-1 pointer-events-none"></div>
              ...
              <div className="relative bg-white rounded-sm overflow-hidden border border-[#B08B46]/30 shadow-xl group">
                <div className="relative aspect-[4/5] sm:aspect-[3/4] overflow-hidden bg-[#FAF7F2]">
                  ...
                  <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-md px-3 py-1.5 rounded-sm border border-[#B08B46]/30 text-[10px] uppercase tracking-widest text-[#8A6B29] font-semibold shadow-sm">
                    Kingdom of Bhutan
                  </div>
                </div>

                {/* Portrait Caption Overlay */}
                <div className="p-6 bg-[#FAF8F5] border-t border-[#B08B46]/20 relative">
        ...
        <div className="mt-16 flex justify-center">
          <a
            href="#chairman"
            className="flex flex-col items-center text-[#5A5854] hover:text-[#B08B46] transition-colors group"
          >
            <span className="text-[10px] uppercase tracking-[0.25em] mb-2 font-semibold">Scroll to Discover</span>
            <ChevronDown className="w-4 h-4 animate-bounce text-[#B08B46]" />
          </a>
        </div>
      </div>
    </section>
