...
export const Food247Section: React.FC = () => {
  ...
  return (
    <section id="food-247-section" className="py-24 bg-[#e9edc9] text-[#1C1D21] relative border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
          <div className="inline-flex items-center space-x-2 px-3.5 py-1 rounded-full bg-[#d4a373]/10 border border-[#d4a373]/30 text-xs uppercase tracking-[0.2em] text-[#ccd5ae] font-semibold">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {pillars.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className="p-6 bg-[#faedcd] border border-[#d4a373]/20 rounded-sm hover:border-[#d4a373] hover:shadow-md transition-all text-center group"
              >
                <div className="w-12 h-12 rounded-full bg-[#d4a373]/10 border border-[#d4a373]/30 flex items-center justify-center mx-auto mb-4 text-[#ccd5ae] group-hover:scale-110 transition-transform">
